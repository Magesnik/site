# Сайт "PETRA HOME" (ул. Пиротска 123) — техническа документация

Статичен сайт за жилищна сграда PETRA HOME (адрес: ул. Пиротска 123) в София. Изграден с HTML, CSS и vanilla JavaScript — без build система, без зависимости, без backend.
